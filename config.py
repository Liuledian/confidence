...
log_file = "/home/PublicDir/liuledian/log/{}_{}_{}.info".format(args.task, args.subject, process_id)
log_file_critical = "/home/PublicDir/liuledian/log/{}_{}_{}.cri".format(args.task, args.subject, process_id)
logger = get_logger()
